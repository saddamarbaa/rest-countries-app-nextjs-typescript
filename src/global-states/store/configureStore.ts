...
import {
  masterReducer as rootReducer,
  ReducerType,
} from 'global-states/reducers/rootReducer';
...
const makeStore = () => {
  ...
  const persistConfig = {
    key: 'nextjs',
    whitelist: ['list-test'], // only these reducers will be persisted, add other reducers if needed and please make sure it does not clash with server keys
