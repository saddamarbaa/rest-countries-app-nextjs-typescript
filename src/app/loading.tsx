        ...
        <div className="flex w-full flex-col items-center">
          <div className="w-full max-w-[90%] justify-between space-y-8 pt-[2.2rem] pb-[2.2rem] sm:flex sm:space-y-0 lg:max-w-[100%]">
            <div className="form-control dar:shadow-xl font-norma xl:max-w-96 mb-3 flex w-full items-center rounded bg-white py-4 px-4 text-base shadow ring-1 ring-slate-900/5 dark:bg-slate-900 sm:w-96">
              ...
              <div className="flex-1 bg-gray-200 dark:bg-gray-500 rounded h-8 ml-2"></div>
            </div>
            <div className="hidden w-full max-w-[300px] items-center sm:flex">
              ...
              <div className="flex items-center">
                <div className="h-4 w-4 bg-amber-500 rounded-full ml-1"></div>
                <div className="h-4 w-4 bg-amber-500 rounded-full ml-1"></div>
                <div className="h-4 w-4 bg-amber-500 rounded-full ml-1"></div>
              </div>
            </div>
            <div className="mb-3 cursor-pointer sm:ml-6">
              <div className="form-control dar:shadow-xl font-norma l dark:bg-dark-element-bg block w-full rounded bg-white px-4 py-4 text-base shadow ring-1 ring-slate-900/5 focus:outline-none dark:bg-slate-900 sm:text-[1.2rem] ">
                <div className="bg-gray-200 dark:bg-gray-500 rounded h-8 w-40"></div>
              </div>
            </div>
          </div>
        </div>
